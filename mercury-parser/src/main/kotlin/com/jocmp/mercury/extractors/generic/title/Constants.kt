...
val STRONG_TITLE_META_TAGS: List<String> =
    listOf(
        "tweetmeme-title",
        "dc.title",
        "rbtitle",
...
val WEAK_TITLE_META_TAGS: List<String> = listOf("og:title")
...
val STRONG_TITLE_SELECTORS: List<String> =
    listOf(
        ".hentry .entry-title",
        "h1#articleHeader",
        "h1.articleHeader",
...
val WEAK_TITLE_SELECTORS: List<String> =
    listOf(
        "article h1",
        "#entry-title",
        ".entry-title",
